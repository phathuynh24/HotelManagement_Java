...
import com.raven.dialog.RoomDialog;
...
public class Form_Room extends javax.swing.JPanel implements DataChangeListener {

    private RoomController roomController;
    private List<Model_Room> rooms;
    private EventAction<Model_Room> eventAction;
    ...
    private void initData() {
        ...
        eventAction = new EventAction<Model_Room>() {
            @Override
            ...
            @Override
            public void update(Model_Room room) {
                roomDialog = new RoomDialog("Update", room, Form_Room.this);
            }
        };
    ...
    private void searchRooms() {
        ...
        for (Model_Room room : rooms) {
            if (roomController.containsKeyword(room, keyword)) {
                model.addRow(room.toRowTable(eventAction));
            }
        }
    }
    ...
    private void initComponents() {
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Tên phòng", "Loại phòng", "Tầng", "Sức chưa", "Thao tác"
            }
        ) {
        ...
        buttonHover1.setText("Thêm Phòng");
    ...
    private void buttonHover1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonHover1ActionPerformed
        roomDialog = new RoomDialog("Add", null, Form_Room.this);        // TODO add your handling code here:
