...
public class Form_Home extends javax.swing.JPanel {
    ...
    private void initTableData() {
        ...
        // Bước 1: Tạo danh sách các đối tượng ModelStudent
        List<ModelStudent> students = new ArrayList<>();
        students.add(new ModelStudent(new ImageIcon(getClass().getResource("/com/raven/icon/profile.jpg")), "Jonh", "Male", "Java", 300));
        students.add(new ModelStudent(new ImageIcon(getClass().getResource("/com/raven/icon/profile1.jpg")), "Dara", "Male", "C++", 300));
        students.add(new ModelStudent(new ImageIcon(getClass().getResource("/com/raven/icon/profile2.jpg")), "Bora", "Male", "C#", 300));
        students.add(new ModelStudent(new ImageIcon(getClass().getResource("/com/raven/icon/profile2.jpg")), "Bora", "Male", "C#", 300));
        students.add(new ModelStudent(new ImageIcon(getClass().getResource("/com/raven/icon/profile2.jpg")), "Bora", "Male", "C#", 300));
        students.add(new ModelStudent(new ImageIcon(getClass().getResource("/com/raven/icon/profile2.jpg")), "Bora", "Male", "C#", 300));
        students.add(new ModelStudent(new ImageIcon(getClass().getResource("/com/raven/icon/profile2.jpg")), "Bora", "Male", "C#", 300));
        ...
        // Bước 2: Sử dụng vòng lặp for để thêm các đối tượng vào bảng
