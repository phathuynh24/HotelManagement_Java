...
public class Action_All<T> extends javax.swing.JPanel {

    public Action_All(ModelAction<T> data) {
        initComponents();
        setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
        cmdEdit.addActionListener(ae -> data.getEvent().update(data.getModel()));
